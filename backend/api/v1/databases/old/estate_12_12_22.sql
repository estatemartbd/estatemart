...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2022 at 11:55 AM
...
INSERT INTO `esm_property` (`id`, `property_name`, `details`, `description`, `category`, `location`, `area`, `purpose`, `size`, `bedroom`, `bathroom`, `price_per_sqft`, `total_price`, `owner_ship`, `floor`, `distance`, `size_calculation_method`, `unit_size`, `total_unit`, `total_floor`, `front_road`, `address`, `indoor_amenities`, `outdoor_amenities`, `is_featured`, `feature_start_date`, `feature_end_date`, `total_inquiries_count`, `total_device_click_count`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'This is propertity_name', 'This is details', 'This is a description', 1, 1, 2, 1, 1200, 4, 1, 50, 5000, 1, 3, '[{\"name\":\"hospital\",\"distance\":10}]', 1, 1, 1, 1, 100, 'This is address', '2__$1', '3', 0, NULL, NULL, 0, 2, 1, 1, 1, '2022-11-24 02:11:53', '2022-12-12 15:46:19'),
(2, 'This is propertity_name test', 'This is details', 'This is a description', 2, 1, 2, 1, 1200, 1, 1, 1, 5000, 1, 3, '[{\"name\":\"hospital\",\"distance\":10}]', 1, 1, 1, 1, 100, 'This is address', '2__$1', '3', 0, NULL, NULL, 0, 1, 1, 1, 1, '2022-11-24 02:12:49', '2022-12-12 15:45:49');
