            ...
            <div className="row">
              <div className="col-lg-12 col-xl-12 mb10">
                <div className="breadcrumb_content style2 mb30-991">
                  <h2 className="breadcrumb_title">Details</h2>
                </div>
              </div>
              ...
              {userData?.status && (
                <div className="col-lg-4">
                  <div className="my_profile_setting_input form-group">
                    <label htmlFor="propertyTitle">Status</label>
                    <input
                      disabled
                      type="text"
                      className="form-control"
                      id="propertyTitle"
                      value={userData?.status === 1 ? 'Active' : 'Desabled'}
                    />
                  </div>
                </div>
              )}
              {userData?.total_active_post && (
                <div className="col-lg-4">
                  <div className="my_profile_setting_input form-group">
                    <label htmlFor="propertyTitle">Active Post</label>
                    <input
                      disabled
                      type="text"
                      className="form-control"
                      id="propertyTitle"
                      value={userData?.total_active_post}
                    />
                  </div>
                </div>
              )}
