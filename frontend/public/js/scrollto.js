...
class StickyNavigation {
	...
	checkAdPosition() {
		...
		let offset = ($('.sticky-ad-tabs').offset().top + $('.sticky-ad-tabs').height() - this.tabContainerHeight) - headerHeight;
		if($(window).scrollTop() > this.lastScroll && $(window).scrollTop() > offset) {
			$('.spa-header').addClass('spa-header--move-up');
			$('.sticky-ad-tabs-container').removeClass('sticky-ad-tabs-container--top-first');
			$('.sticky-ad-tabs-container').addClass('sticky-ad-tabs-container--top-second');
		} 
		else if($(window).scrollTop() < this.lastScroll && $(window).scrollTop() > offset) {
			$('.spa-header').removeClass('spa-header--move-up');
			$('.sticky-ad-tabs-container').removeClass('sticky-ad-tabs-container--top-second');
			$('.sticky-ad-tabs-container').addClass('sticky-ad-tabs-container--top-first');
		}
		else {
			$('.spa-header').removeClass('spa-header--move-up');
			$('.sticky-ad-tabs-container').removeClass('sticky-ad-tabs-container--top-first');
